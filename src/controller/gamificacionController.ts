...
export async function obtenerMiProgreso(req: Request, res: Response) {
  try {
    ...
    return res.status(500).json({ message: 'Error al obtener progreso', error: err });
  }
}
...
export async function obtenerRanking(req: Request, res: Response) {
  try {
    ...
    return res.status(500).json({ message: 'Error al obtener ranking', error: err });
  }
}
...
export async function obtenerInsignias(req: Request, res: Response) {
  try {
    ...
    return res.status(500).json({ message: 'Error al obtener insignias', error: err });
  }
}
...
export async function inicializarInsignias(req: Request, res: Response) {
  try {
    ...
    return res.status(200).json({ message: 'Insignias inicializadas correctamente' });
  } catch (err) {
    logger.error(`Error al inicializar insignias: ${err}`);
    return res.status(500).json({ message: 'Error al inicializar insignias', error: err });
  }
}